...
function select_pw($q,$p) {
	...
	function printHTML() {
		...
		$file = $header.file_get_contents("template/Lista_Portadas_Informativas.html").$footer;
		$file = str_replace("@@CURRENTSITE@@", "Lista_Portadas", $file);
