...
function select_pw($q,$p) {
	...
	function printHTML() {
		...
		$file = $header.file_get_contents("template/Lista_Boletines.html").$footer;
		$file = str_replace("@@CURRENTSITE@@", "Lista_Boletines", $file);
