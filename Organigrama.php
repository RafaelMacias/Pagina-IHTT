...
function Organigrama(){
	...
	function printHTML() {
		...
		$file = $header.file_get_contents("template/Organigrama.html").$footer;
		$file = str_replace("@@CURRENTSITE@@", "Organigrama", $file);
		...
		$file = str_replace("{{title_viñeta}}", "Organigrama", $file);
