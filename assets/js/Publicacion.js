...
$('.determinate').css('width','0%')
    ...
    if($("#posimagen").val()==null){
      toastwarning("Debe seleccinar una posición para su imagen");
      return;
    }
    ...
    var form_data = new FormData();
    form_data.append("action","save-img-publicacion");
    form_data.append("nombreimg",$('#nombreimg').val());
    form_data.append("posimagen",$('#posimagen').val());
...
function RecuperarImgPublicacion(nombre) {
  ...
  var dataurl = 'Documentos/Imagenes/Noticias/'+nombre;
