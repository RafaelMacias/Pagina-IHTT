   ...
   $.get( "Api_PW.php", parameters, null, "json" )
    .done(function(datos) {
      ...
      for (var i = 0; i < datos.length; i++) {
        ...
        content += '<div class="card border-light mb-4 text-left" style="min-width: 100%;"> <div class="row no-gutters align-items-center"> <div class="col-12 col-lg-3 col-xl-3" style="text-align: center;border-right: solid 1px #e6e7e8;"> <a href="#"> <img data-pdf-thumbnail-file="Documentos/'+datos[i].DESC_Categoria+'/'+datos[i].Nombre_Documento+'" data-pdf-thumbnail-height="150"> </a> </div> <div class="col-12 col-lg-6 col-xl-8"> <div class="card-body py-lg-0"> <div class="d-flex no-gutters align-items-center mb-2"> <div> <ul class="list-group mb-0"> <li class="list-group-item small p-0"><span class="far fa-calendar-alt text-tertiary mr-2 text-turqueza"></span>Fecha de Documento: '+datos[i].Sistema_Fecha+'</li> </ul> </div> '+btn+' </div> <a target="_blank" onclick="saveTotalVistasDocumento(\''+datos[i].ID_Documento+'\',\''+n+'\');" href="Documentos/'+datos[i].DESC_Categoria+'/'+datos[i].Nombre_Documento+'"> <h2 class="h5 text-gris">'+datos[i].Nombre_Documento+'</h2> </a> <div class="col d-flex pl-0"><span class="font-small mr-3"><span class="fas fa-weight mr-2 text-turqueza"></span>'+datos[i].Size_Documento+' '+datos[i].Tipo_Unidad+'</span> <span class="text-muted font-small mr-3"><span class="fas fa-eye mr-2 text-turqueza"></span><span class="text-gris">'+n+'</span></span>  </div> </div> </div> </div> </div>';
